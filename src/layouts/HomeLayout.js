    ...
    <div>
      <div className="lg:py-20 lg:px-28 py-10 px-6 bg-primary text-white">
        <nav className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="relative lg:hidden">
              ...
              {/* Mobile menu */}
              {isOpen && (
                <div className="w-40 absolute top-8 right-0 bg-third text-black py-2 px-4 rounded shadow-lg">
        ...
        <div className="flex flex-col items-center mt-10 lg:mt-20 mb-6 lg:mb-10">
          ...
          <p className="text-lg lg:text-3xl font-light text-center text-third">
        ...
        <div className="flex lg:justify-center items-center gap-3">
          {/* search inputs */}
          <div className="bg-third flex justify-start items-center rounded lg:w-96 w-full">
            <div>
          ...
          <div className="hidden md:block">
            <Button name="Search" textColor="primary" bgColor="third" />
          </div>
        </div>
      </div>
      <div>
